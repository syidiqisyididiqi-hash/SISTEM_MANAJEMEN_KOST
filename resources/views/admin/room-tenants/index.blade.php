...
@section('title', 'Data Penyewa Kamar')
    ...
    <x-ui.card>
        ...
        @if($roomTenants->count())
                ...
                <tbody>
                    ...
                    @foreach($roomTenants as $item)
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                {{ $roomTenants->firstItem() + $loop->index }}
                            </td>
                        ...
                        : '-' }}
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="flex justify-center gap-2">
                                    ...
                                    <form action="{{ route('admin.room-tenants.destroy', $item) }}" method="POST"
            ...
            <div class="mt-6 flex justify-center">
                {{ $roomTenants->withQueryString()->links() }}
            </div>
        ...
        document.querySelectorAll('.form-delete').forEach(form => {
            ...
            form.addEventListener('submit', function (e) {
                ...
                Swal.fire({
                    icon: 'warning',
                    title: 'Hapus Data?',
                    text: 'Apakah Anda yakin ingin menghapus data room tenant ini? Tindakan ini tidak bisa dibatalkan!',
                    width: '400px',
